...
//     let query: string = searchQuery === null ? `givenName:${index}*` : searchQuery.replace(/'/g, `''`);
...
//       .get(`${this.props.webUrl}/_api/web/lists/getbytitle('EmployeeDirectory')/Items?$select=givenName,surname,empFullName,jobTitle,userPrincipleName/EMail&$expand=userPrincipleName &$filter=startswith(givenName,'"+searchQuery+"')` , SPHttpClient.configurations.v1, {
//       headers: headers
//       })
...
//         let people: IPerson1[] = res.PrimaryQueryResult.RelevantResults.Table.Rows.map(r => {
//           return {
           
//              givenName:this.__getValueFromSearchResult('givenName', r.cells)
//              surname:this.__getValueFromSearchResult('surname', r.cells)
//              empFullName:this.__getValueFromSearchResult('empFullName', r.cells)
//              jobtitle:this.__getValueFromSearchResult('jobTitle', r.cells)
//              userPrincipleName:this.__getValueFromSearchResult('userPrincipleName', r.cells)
...
//           people = people.reduce((result: IPerson1[], person: IPerson1) => {
